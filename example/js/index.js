      ...
      function (require, module, exports) {
        ...
        function jsonToQueryString(payload) {
          return Object.keys(payload)
            .map((key) => ''.concat(encodeURIComponent(key), '=').concat(encodeURIComponent(payload[key])))
            .join('&');
        }
        /**
        ...
        function camelToSnake(payload, hyphenated = false) {
          return payload && payload[0].toLowerCase() + payload.slice(1, payload.length).replace(/[A-Z]/g, (letter) => ''.concat(hyphenated ? '-' : '_').concat(letter.toLowerCase()));
        }
 ...
 */
        ...
        function meta() {
          ...
          if (this.metaTags.url) {
            ...
            metaObj.meta.canonical = {
              rel: 'canonical',
              href: this.metaTags.url
            };
          }
    ...
    'src/index.js': [
      function (require, module, exports) {
        ...
        exports.utils = exports.store = exports.default = void 0;
      ...
      { './store': 'src/store/index.js', './utils': 'src/utils/index.js' }
    ],
    'index.js': [
      function (require, module, exports) {
        'use strict';
  ...
  {},
  ['../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js', 'index.js'],
  null
);
